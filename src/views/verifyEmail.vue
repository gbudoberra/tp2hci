          ...
          <v-container>
            <v-row>
              <v-col align-self="center">
                ...
                <v-card-subtitle class="text-h5"> We sent you a code to your email, click the link or enter it as
                  follows
                </v-card-subtitle>
              </v-col>
              <v-col cols="5" align-self="center">
                ...
                <v-row>
                  <v-col align="center">
                    <v-btn @click="resend(email)" color="#ff5252" dark>RESEND CODE</v-btn>
                  </v-col>
                  <v-col align="center">
                    <v-btn @click="verify(code, email)" color="#388E3C" dark>VERIFY</v-btn>
                  </v-col>
                </v-row>
